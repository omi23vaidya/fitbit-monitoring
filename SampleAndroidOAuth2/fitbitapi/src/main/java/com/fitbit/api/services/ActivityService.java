...
public class ActivityService {
 ...
 //   private final static String ACTIVITIES_URL = "https://api.fitbit.com/1/user/-/activities/steps/date/%s/7d.json";
    ...
    private static final String dateFormat = "today";
    public static Loader<ResourceLoaderResult<DailyActivitySummary>> getDailyActivitySummaryLoader(Activity activityContext, Date date) throws MissingScopesException, TokenExpiredException {
        ...
        return USER_ACTIVITIES_LOADER_FACTORY.newResourceLoader(activityContext, new Scope[]{Scope.activity}, dateFormat);
    }
